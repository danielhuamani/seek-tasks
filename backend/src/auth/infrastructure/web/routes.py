...
from src.auth.infrastructure.web.schemas import UserCreateBody, UserResponse, LoginRequest, LoginResponse
...
def get_logged_user(current_user=Depends(get_current_user), service: UserService = Depends(get_service)):
